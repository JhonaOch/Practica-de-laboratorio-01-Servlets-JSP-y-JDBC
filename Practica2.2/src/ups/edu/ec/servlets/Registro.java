...
public class Registro extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("Nombre:"+cedula+"  Persona:"+ nombres +"   Apellido:" +apellidos + "  Correo:" +correo +" Contrasena " + contrasena);
        
        DAOFactory.getDAOFactory().createTables();
        PersonaDAO personaDao = DAOFactory.getDAOFactory().getPersonaDAO();
        Persona persona = new Persona(cedula, nombres, apellidos, correo, contrasena, activo);
